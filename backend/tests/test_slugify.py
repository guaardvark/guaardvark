...
class TestSlugifyUtility:
    ...
    def test_slugify_special_characters(self):
        ...
        assert (
            slugify("Title with Spéciàl Chäräctërs") == "title-with-special-characters"
        )
    ...
    def test_slugify_symbols_and_punctuation(self):
        ...
        assert (
            slugify("Title!!! with @#$ symbols & stuff") == "title-with-symbols-stuff"
        )
    ...
    def test_slugify_leading_trailing_dashes(self):
        ...
        assert (
            slugify("---Leading and Trailing Dashes---")
    ...
    def test_slugify_non_english_characters(self):
        ...
        assert (
            slugify("Ñoñó Español & François Français")
            == "nono-espanol-francois-francais"
        )
    ...
    def test_javascript_compatibility(self):
        ...
        for input_title, expected in test_cases:
            ...
            assert (
                result == expected
            ), f"Failed for input '{input_title}': expected '{expected}', got '{result}'"
