...
class ResponseFormatter:
    ...
    def validation_error_response(
        error: str, error_details: Optional[str] = None, status_code: int = 400
    ) -> GenerationResponse:
    ...
    def not_found_error_response(
        error: str, error_details: Optional[str] = None, status_code: int = 404
    ) -> GenerationResponse:
    ...
    def server_error_response(
        error: str, error_details: Optional[str] = None, status_code: int = 500
    ) -> GenerationResponse:
...
def format_validation_error(
    ...
    response = ResponseFormatter.validation_error_response(
        error=error, error_details=error_details, status_code=status_code
    )
    return response.to_json_response()
