...
def _ensure_indexes(inspector):
    ...
    required = [
        ...
        # interconnector
        ('ix_interconnector_sync_profiles_name', 'interconnector_sync_profiles', ['name'], False),
        # wordpress_sites
        ...
        # wordpress_pages
        ('ix_wordpress_pages_wordpress_site_id', 'wordpress_pages', ['wordpress_site_id'], False),
        ('ix_wordpress_pages_wordpress_post_id', 'wordpress_pages', ['wordpress_post_id'], False),
        ...
        ('ix_wordpress_pages_process_status', 'wordpress_pages', ['process_status'], False),
        ('ix_wordpress_pages_review_status', 'wordpress_pages', ['review_status'], False),
        ('ix_wordpress_pages_push_status', 'wordpress_pages', ['push_status'], False),
        ('ix_wp_page_site_post', 'wordpress_pages', ['wordpress_site_id', 'wordpress_post_id'], False),
        ('ix_wp_page_process_status', 'wordpress_pages', ['process_status', 'pull_status'], False),
        ('ix_wp_page_review_status', 'wordpress_pages', ['review_status', 'process_status'], False),
        ('ix_wp_page_seo_score', 'wordpress_pages', ['seo_score'], False),
        ('ix_wp_page_seo_plugin', 'wordpress_pages', ['seo_plugin'], False),
        ('ix_wp_page_analytics_synced', 'wordpress_pages', ['analytics_synced_at'], False),
    ]
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('name'),
        sa.ForeignKeyConstraint(['client_id'], ['clients.id'], name='fk_project_client_id'),
    )
    ...
    op.create_table(
        ...
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='fk_rule_project_id', ondelete='SET NULL'),
        sa.CheckConstraint(
        ...
        sa.CheckConstraint('LENGTH(rule_text) <= 50000', name='ck_rule_text_length_extended'),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='fk_assoc_project_id', ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['rule_id'], ['rules.id'], name='fk_assoc_rule_id', ondelete='CASCADE'),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='fk_website_project_id', ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['client_id'], ['clients.id'], name='fk_website_client_id', ondelete='SET NULL'),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='fk_task_project_id', ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['client_id'], ['clients.id'], name='fk_task_client_id', ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['website_id'], ['websites.id'], name='fk_task_website_id', ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['parent_task_id'], ['tasks.id'], name='fk_task_parent_id', ondelete='SET NULL'),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['parent_id'], ['folders.id'], name='fk_folder_parent_id', ondelete='CASCADE'),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('path'),
        sa.ForeignKeyConstraint(['folder_id'], ['folders.id'], name='fk_document_folder_id', ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['client_id'], ['clients.id'], name='fk_document_client_id', ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='fk_document_project_id', ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['website_id'], ['websites.id'], name='fk_document_website_id', ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['source_document_id'], ['documents.id'], name='fk_document_source_id', ondelete='SET NULL'),
    )
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='fk_llmsession_project_id', ondelete='SET NULL'),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['session_id'], ['llm_sessions.id'], name='fk_llmmessage_session_id'),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['node_id'], ['interconnector_nodes.node_id'], ondelete='CASCADE'),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['broadcast_id'], ['interconnector_broadcasts.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['node_id'], ['interconnector_nodes.node_id'], ondelete='CASCADE'),
    )
    ...
    op.create_table(
        ...
        sa.Column('connection_type', sa.String(50), default='llamanator', nullable=False),
        sa.Column('client_id', sa.Integer(), nullable=True),
        sa.Column('project_id', sa.Integer(), nullable=True),
        sa.Column('website_id', sa.Integer(), nullable=True),
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('url'),
        sa.ForeignKeyConstraint(['client_id'], ['clients.id'], name='fk_wp_site_client_id', ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='fk_wp_site_project_id', ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['website_id'], ['websites.id'], name='fk_wp_site_website_id', ondelete='SET NULL'),
    )
    ...
    op.create_table(
        ...
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['wordpress_site_id'], ['wordpress_sites.id'], name='fk_wp_page_site_id', ondelete='CASCADE'),
    )
