...
metadata_indexing_bp = Blueprint(
    "metadata_indexing", __name__, url_prefix="/api/metadata"
)
...
def index_job_metadata(task_id):
    ...
    try:
        ...
        return (
            jsonify(
                {"success": False, "error": f"Failed to index job metadata: {str(e)}"}
            ),
            500,
        )
...
def reindex_all_metadata():
    ...
    try:
        ...
        return (
            jsonify(
                {"success": False, "error": f"Failed to reindex all metadata: {str(e)}"}
            ),
            500,
        )
...
def get_metadata_indexing_status():
    ...
    try:
        ...
        return (
            jsonify(
                {"success": False, "error": f"Failed to get metadata status: {str(e)}"}
            ),
            500,
        )
