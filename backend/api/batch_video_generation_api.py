...
VIDEO_MODEL_REGISTRY = {
    ...
    "wan22-14b": {
        "name": "Wan 2.2 14B (GGUF Q5_K)",
        "description": "State-of-the-art video generation. MoE architecture, best quality on 16GB GPU.",
        "hf_repo": "QuantStack/Wan2.2-T2V-A14B-GGUF",
        "hf_filename": "Wan2.2-T2V-A14B-Q5_K_M.gguf",
        "local_subdir": "diffusion_models",
        "check_files": ["Wan2.2-T2V-A14B-Q5_K_M.gguf"],
        "size_gb": 10.5,
        "vram_mb": 11000,
        "type": "wan",
    },
    "wan-vae": {
        ...
        "hf_filename": "wan_2.1_vae.safetensors",
        "local_subdir": "vae",
    ...
    "t5-encoder": {
        ...
        "description": "Required by CogVideoX and Wan models for text encoding. Shared dependency.",
