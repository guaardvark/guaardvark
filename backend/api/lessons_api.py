    ...
    with app.app_context():
        try:
            ...
            prompt = (
                ...
                "- For click steps, describe the target by visible appearance — the "
                "  shape, color, or text on the element ('click the Firefox icon on "
                "  the desktop', 'click the Send button below the comment box', "
                "  'click the close icon in the top-right of the modal'). NEVER include "
                "  pixel coordinates like 'x=92' or '(640, 660)' — the agent's vision "
                "  model finds targets fresh on each frame, so coordinates rot the "
