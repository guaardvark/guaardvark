    ...
    with app.app_context():
        try:
            ...
            prompt = (
                ...
                "  (≤4 words, one distinctive adjective). Shape examples: "
                "  'Firefox icon', 'search input field', 'Send button', "
                "  'close icon'. Long descriptions break the vision detector. "
                "  Long-form context belongs in self_knowledge_compact.md, not "
                "  in target_description.\n"
