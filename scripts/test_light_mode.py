...
def format_results(light_result, full_result):
    ...
    print(
        f"Files: {light_result['document_count']}, Folders: {light_result['folder_count']}"
    )
    ...
    print(
        f"{'Response Time':<30} {light_time:>10.1f} ms      {full_time:>10.1f} ms      {time_improvement:.1f}x faster"
    )
    ...
    print(
        f"{'Response Size':<30} {light_size:>10.1f} KB      {full_size:>10.1f} KB      {size_improvement:.1f}x smaller"
    )
