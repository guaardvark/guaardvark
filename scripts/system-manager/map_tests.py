    ...
    def scan_test_files(self):
        ...
        for test_file in tests_dir.rglob("*.py"):
            if (
                ...
                or "test" in test_file.parent.name.lower()
            ):
    ...
    def get_test_statistics(self) -> Dict:
        ...
        stats = {
            ...
            "total_test_functions": sum(
                len(t.get("test_functions", [])) for t in self.test_files
            ),
            "total_test_classes": sum(
                len(t.get("test_classes", [])) for t in self.test_files
            ),
    ...
    def save_results(self, output_file: str):
        ...
        results = {
            ...
            "component_to_test_map": {
                comp: tests for comp, tests in self.component_to_test_map.items()
            },
