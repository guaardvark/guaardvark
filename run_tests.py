...
def _ensure_llama_index() -> None:
    ...
    If llama_index is missing, attempt to install it using pip.
    """
    try:
        import llama_index
...
def install_requirements(repo_root: str) -> None:
    """
    Install requirements from files in the backend directory.
...
def install_playwright_browsers() -> None:
    ...
    Attempt to install chromium using playwright.__main__.main.
    """
    try:
...
def install_node_modules(repo_root: str) -> None:
    """
    Install node modules in the frontend directory.
...
def _parse_pytest_output(output: str) -> dict:
    """
    Parse pytest output to extract counts and failures.

    :param output: The output of pytest.
    :return: A dictionary containing counts and failures.
    """
